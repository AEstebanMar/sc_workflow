...
make_vln(before.seu, 'nFeature_RNA')
```
</div>
...
make_vln(before.seu, 'nCount_RNA')
```
</div>
<div class="superbigimage">
...
- **nFeature_RNA**: number of expressed (detected) genes/features per cell
...
#FeatureScatter(before.seu, feature1 = "nCount_RNA", feature2 = "percent.mt")
```
...
#FeatureScatter(before.seu, feature1 = "nCount_RNA", feature2 = "nFeature_RNA")
```
...
#FeatureScatter(before.seu, feature1 = "nCount_RNA", feature2 = "percent.rb")
```
